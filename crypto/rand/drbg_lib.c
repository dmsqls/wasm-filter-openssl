...
static unsigned long master_reseed_time_interval = MASTER_RESEED_TIME_INTERVAL;
static unsigned long slave_reseed_time_interval  = SLAVE_RESEED_TIME_INTERVAL;
 ...
 * Returns 1 on success, 0 on failure.
 */
int RAND_DRBG_set_reseed_time_interval(RAND_DRBG *drbg, unsigned long interval)
{
...
int RAND_DRBG_set_reseed_defaults(
                                  ...
                                  unsigned long _master_reseed_time_interval,
                                  unsigned long _slave_reseed_time_interval
                                  )
{
