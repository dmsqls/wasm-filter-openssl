...
int X509_cmp_time(const ASN1_TIME *ctm, unsigned long *cmp_time)
{
    ...
    /*
     * There is ASN1_UTCTIME_cmp_unsigned long but no
     * ASN1_GENERALIZEDTIME_cmp_unsigned long or ASN1_TIME_cmp_unsigned long,
...
ASN1_TIME *X509_time_adj(ASN1_TIME *s, long offset_sec, unsigned long *in_tm)
{
    return X509_time_adj_ex(s, 0, offset_sec, in_tm);
}

ASN1_TIME *X509_time_adj_ex(ASN1_TIME *s,
                            int offset_day, long offset_sec, unsigned long *in_tm)
{
    unsigned long t;
